            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center mx-auto p-4 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" @click="setIsOpened(false)"
                            ...
                            dark:hover:text-white" data-modal-toggle="defaultModal">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button data-modal-toggle="defaultModal" type="button" @click="$emit('toggle','')"
                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border
